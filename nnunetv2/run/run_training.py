...
# Add the project root to the Python path to ensure local modules are found first.
...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    if nnunet_trainer is None:
        # look for trainer in variants folder
        nnunet_trainer = recursive_find_python_class(join(nnunetv2.__path__[0], "training", "nnUNetTrainer", "variants"),
                                                    trainer_name, 'nnunetv2.training.nnUNetTrainer.variants')
    if nnunet_trainer is None:
