...
def main():
    ...
    for pf in plans_files:
        ...
        # Filter for configurations requested by the user
        ...
        try:
            # we need to get the preprocessor name from the plans file
            preprocessor_name = plans['preprocessor_name']
            preprocess_dataset(
                dataset_id=args.dataset_id,
                plans_identifier=plans_name,
                configurations=list(configurations_to_process.keys()),
