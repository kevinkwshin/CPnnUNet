...
def main():
    ...
    parser.add_argument('--variance_scaling', type=float, default=1.0, help='Factor to scale the variance of the prior network. Default: 1.0')
    ...
    trainer = ProbabilisticUNetTrainer(
        ...
        variance_scaling_factor=args.variance_scaling, # Pass the new argument
